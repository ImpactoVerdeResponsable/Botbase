...
def get_signal(df, params, vol_ratio, macro_trend_is_up, transaction_id, **kwargs):
    ...
    try:
        ...
        cvd_ticks = int(strat_params.get("CVD_CONFIRMATION_TICKS", 1))
        max_spread_bp = Decimal(str(strat_params.get("MAX_SPREAD_BP", 3)))
        ...
        # Condición 3: CVD (Delta) positivo
        cond_3_cvd_positive = (cvd_tick > 0) # Asumiendo ticks positivos
        ...
        if conditions:
            ...
            signal = {
                ...
                "stop_loss_price": support_levels[0] - Decimal('0.01') if support_levels else None, # (Asumiendo 21.44 -> 21.43)
                
                # Instrucción: "Take-profit: air-pocket mid"
                "take_profit_price": air_pocket_targets[0] if air_pocket_targets else None, # (Asumiendo 21.54)
